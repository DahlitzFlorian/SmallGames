========================================================================
    KONSOLENANWENDUNG: PlaySmallGames-Projektübersicht
========================================================================

Diese PlaySmallGames-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre PlaySmallGames-Anwendung besteht.


PlaySmallGames.vcxproj
...
PlaySmallGames.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen PlaySmallGames.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
